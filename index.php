    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="<?php echo bloginfo('template_url'); ?>/assets/img/LOGO-OFICIAL-solo-forma.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-2 col-4">
            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/clients/logo.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="200">
          </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
              PRACMATIK S.R.L es una empresa que ofrece Insumos de bioseguridad, ofrecemos soluciones para todos los sectores, cumpliendo normas de calidad, garantizamos un servicio confiable y cordial.
            </p>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            ...
            <h4>Visión</h4>
            <p>
              Nos proyectamos como una Empresa reconocida a Nivel Nacional que brinda soluciones efectivas en el Area de Bioseguridad, entregando un servicio de calidad a precios competitivos.
            </p>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>COMPROMISO</strong>  con nuestros clientes y todas sus necesidades.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    <i class="icofont-simple-smile"></i>
                    <!--<span data-toggle="counter-up"></span>-->
                    <p><strong>INNOVACION</strong> de nuestros metodos para brindarle el mejor servicio.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    <i class="icofont-simple-smile"></i>
                    <!--<span data-toggle="counter-up"></span>-->
                    <p><strong>SINERGIA</strong> en nuestro equipo interno, obteniendo resultados eficientes.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    <i class="icofont-simple-smile"></i>
                    <!--<span data-toggle="counter-up"></span>-->
                    <p><strong>EXCELENCIA</strong> un camino constante que recorremos con usted.</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2 id="services_title">Políticas</h2>
          <p>Nuestras actividades compromenten el cuidando de la seguridad y la salud de nuestro personal.</p>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">Afianzar continuamente la <strong>relación con los clientes</strong> con el fin de crear lazos fuertes de trabajo y mejora de nuestros servicios.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">Cumplir con la <b>legislación laboral</b> vigente en materia de seguridad, salud ocupacional, medio ambiente y calidad.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <p class="description">Garantizar que los productos entregados cumplan con <b>estándares de calidad</b>.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              ...
              <p class="description">Ejecutar nuestras actividades manteniendo nuestro compromiso con el <b>medio ambiente</b>.</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2 id="products_title">Productos</h2>
          <p><b>INSUMOS DE BIOSEGURIDAD</b></p>
        </div>

        <div class="row" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter=".filter-web" class="filter-active">1</li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="contact-about">
              <img src="<?php echo bloginfo('template_url'); ?>/assets/img/LOGO-OFICIAL-sin-sombra.png" alt="" height="150" width="150">
              <p>Nuestra atención es a nivel Bolivia, contamos con alianzas estratégicas con empresas que ofrecen servicios confiables de transporte de puerta a puerta.</p>
              <div class="social-links">
                <a target="_blank" href="https://www.facebook.com/pracmatik" class="facebook"><i class="icofont-facebook"></i></a>
                <a target="_blank" href="https://www.instagram.com/pracmatik.srl" class="instagram"><i class="icofont-instagram"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            <div class="info">
              ...
              <div>
                ...
                <p><a href="mailto:administracion@pracmatik.com">administracion@pracmatik.com</a></p>
              </div>
          ...
          <div class="col-lg-5 col-md-12">
            <form action="<?php echo admin_url( 'admin-post.php' ) ?>" method="post" role="form" class="php-email-form">
              <div class="form-group">
                <input required type="text" name="name" class="form-control" id="name" placeholder="Tu nombre" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
                <input required type="email" class="form-control" name="email" id="email" placeholder="Tu Email" data-rule="email" data-msg="Please enter a valid email" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
                <input required type="text" class="form-control" name="subject" id="subject" placeholder="Asunto" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
                <textarea required class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Mensaje ..."></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
